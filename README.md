`Hi! This is an outdated and no longer updating repository. Feel free to check this new, fresh and modern [version] (https://github.com/kastergarta/Hawkathon-SPA-Project)`
